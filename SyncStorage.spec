...
Requires: nginx memcached gunicorn python26 pylibmc python26-setuptools python26-webob python26-paste python26-pastedeploy python26-services python26-pastescript python26-sqlalchemy python26-simplejson
