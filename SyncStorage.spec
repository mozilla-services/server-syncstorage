...
Requires: nginx memcached gunicorn python26 python26-memcached python26-setuptools python26-webob python26-paste python26-pastedeploy python26-services >= 0.2 python26-pastescript python26-sqlalchemy python26-simplejson
